...
class Plan(BaseModel):
    ...
    techstack: str = Field(
        description="The tech stack to be used for the app, e.g. Python, JavaScript, React, FastAPI, etc."
    )
...
class CoderState(BaseModel):
    ...
    current_step_idx: int = Field(0, description="The index of the current implementation step")
...
class TestResult(BaseModel):
    passed: bool = Field(description="Whether the generated project passed basic validation")
